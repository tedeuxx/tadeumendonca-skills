  ...
  case "$agent_type" in
    *:quality-assurance)
    ...
    | if $h == "" then ""
        ...
        # TWO merge-authorising literals since 2026-08-22, not one (ADR-0002 amendment #15, ADR-0004's
