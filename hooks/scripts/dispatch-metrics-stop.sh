...
#                       per ADR-0015) posted REQUEST-CHANGES on the PR before it merged — so this hook
#                       reads it from the PR's own gatekeeper-verdict / harness-lead-verdict comments
#                       (the ADR-0006 / ADR-0015 markers, already the durable record of that fact)
...
# `gatekeeper-verdict` (ADR-0006) and `harness-lead-verdict` (ADR-0015) — chosen for consistency
