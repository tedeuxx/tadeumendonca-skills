...
module "cognito" {
  ...
  user_pool_name           = "tadeumendonca-${var.environment}"
  ...
  domain          = "auth-${var.environment}-tadeumendonca"   # Cognito-managed prefix (fallback)
  custom_domain   = var.auth_domain_name                      # auth.{env}.tadeumendonca.io
