...
| `<apex-domain>` | `var.apex_domain` | the registrable apex; per-env hosts derive from it (`/route53`) |
| `<github-org>` | `var.github_org` | OIDC trust subjects `repo:<github-org>/<project>-pwa:*` (`/iam`) |
