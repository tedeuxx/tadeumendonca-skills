...
| [0006](./0006-a-verdict-owed-to-another-persona-is-an-artifact.md) | A verdict one persona owes another is an artifact on the PR, not a relayed claim | accepted · **amended 2026-08-04** (the open question's premise is falsified by ADR-0002 amendment #9 — `marketing-lead` no longer exists and the copy lens now holds `Bash`; the hole it named survives, the decision is unchanged) |
