...
| [0007](./0007-the-merge-precondition-is-a-floor-not-an-instruction.md) | The merge precondition is a floor, not an instruction — enforced by a hook, not by prose the gate reads | proposed |
