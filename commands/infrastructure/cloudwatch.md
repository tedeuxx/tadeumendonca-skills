...
- Module-created groups (lambda / flow-log) set retention via the module input; standalone `aws_cloudwatch_log_group` resources set it directly. All groups are KMS-encrypted (`/infrastructure/kms`).
